...
class Profile extends Component {
  ...
  isOwner = (profileId, loggedInId) => {
    return profileId === loggedInId;
  };
  ...
  render() {
    ...
    this.isOwner(profile.id, getLoggedInUser().id);
    console.log(getLoggedInUser());
    const owner = this.isOwner(profile.id, getLoggedInUser().id);
    let leftMenu;
    if (owner === true) {
      leftMenu = <LeftProfile menuList={menuList} owner />;
    } else {
      leftMenu = '';
    }
